...
- **Required Viewports**: UI changes MUST remain valid in the desktop, 1140px compact desktop, and 390px mobile Chromium projects defined in `playwright.config.js`.
